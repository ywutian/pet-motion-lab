...
BASE_POSE_PROMPTS = {
    ...
    "walk": "卡通3D{breed}{color}{species}，纯白色背景，四脚着地自然往前走，前后脚交替移动，不能同时离地，镜头面对{species}的正前方。",
...
# 过渡视频提示词（图生视频）
TRANSITION_PROMPTS = {
    # 步骤3：首批3个过渡视频（用于生成walk/rest/sleep基础图）
    "sit2walk": "卡通3D{breed}{color}{species}，纯白色背景，宠物起立，然后四脚着地自然往前走，前后脚交替移动，不能同时离地，镜头面对{species}的正前方。",
    ...
    # 步骤4：剩余9个过渡视频（所有姿势间的其他过渡）
    "sit2sleep": "卡通3D{breed}{color}{species}，纯白色背景，宠物趴下，然后睡觉，镜头面对{species}的正前方。",
    "walk2sit": "卡通3D{breed}{color}{species}，纯白色背景，宠物四脚着地自然往前走，前后脚交替移动，然后坐下，镜头面对{species}的正前方。",
    "walk2sleep": "卡通3D{breed}{color}{species}，纯白色背景，宠物四脚着地自然往前走，前后脚交替移动，然后睡觉，镜头面对{species}的正前方。",
    "walk2rest": "卡通3D{breed}{color}{species}，纯白色背景，宠物四脚着地自然往前走，前后脚交替移动，然后休息，镜头面对{species}的正前方。",
    "sleep2walk": "卡通3D{breed}{color}{species}，纯白色背景，宠物睁眼，然后起立，四脚着地自然往前走，前后脚交替移动，不能同时离地，镜头面对{species}的正前方。",
    ...
    "rest2walk": "卡通3D{breed}{color}{species}，纯白色背景，宠物起立，然后四脚着地自然往前走，前后脚交替移动，不能同时离地，镜头面对{species}的正前方。",
}
